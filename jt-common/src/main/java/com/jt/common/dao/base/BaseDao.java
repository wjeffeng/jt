...
public interface BaseDao<T> {
     ...
     * @return
     */
    @DeleteProvider(type = BaseDaoProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @SelectProvider(type = BaseDaoProvider.class, method = "dynamicSQL")
     ...
     * @return
     */
    @InsertProvider(type = BaseDaoProvider.class, method = "dynamicSQL")
    int insert(T record);
     ...
     * @return
     */
    @UpdateProvider(type = BaseDaoProvider.class, method = "dynamicSQL")
