...
<body id="mainframe">
	...
	<div class="w" id="headers">
		<div id="logo">
			<a href="http://www.jd.com/"><img alt="京淘商城" src="/images/jt-logo.png"></a>
		</div>
		...
		<div class="m m3 msop">
			...
			<div class="mc" id="success_detail">
				<ul class="list-order">
					<li class="li-st">
						<div class="fore1">
							订单号：<a href="javascript:void(0)">${order.orderId }</a>
						</div> <!-- 货到付款 -->
						<div class="fore2">
							货到付款：<strong class="ftx-01">${order.payment}元</strong>
						</div>
						<div class="fore3">京淘快递 &nbsp; 送货时间: 预计 ${date} 送达&nbsp;</div>
					</li>
				</ul>
				<!-- 在线支付按钮  -->
				<div id="bookDiv"></div>
