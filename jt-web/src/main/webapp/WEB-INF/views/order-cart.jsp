...
<body id="mainframe">
	...
	<form id="orderForm" class="hide">
		...
		<input type="hidden" name="orderShipping.receiverName" value="汪俊峰" /> <input
			type="hidden" name="orderShipping.receiverMobile" value="18855888855" />
		<input type="hidden" name="orderShipping.receiverState" value="北京" />
		<input type="hidden" name="orderShipping.receiverCity" value="北京" /> <input
			type="hidden" name="orderShipping.receiverDistrict" value="海淀区" /> <input
			type="hidden" name="orderShipping.receiverAddress" value="清华大学" />
	</form>
	<div class="w w1 header clearfix">
		<div id="logo">
			<a href="http://front.jt.com/"><img src="/images/jt-logo.png"
				alt="京淘商城" /></a>
		</div>
															...
															<tbody>
																<tr class="hide">
																	...
																	<td class="p-price"><strong> ￥<fmt:formatNumber
																				...
																				minFractionDigits="2" value="${item.price/1000 }" />
																	</strong></td>
																...
																<tr>
																	<td class="fore1">
																		<div class="p-goods">
																			<div class="p-img">
																				<a
																					href="http://front.jt.com/item/${cart.itemId}.html"
																	...
																	<td class="p-price"><strong>￥<fmt:formatNumber
																				groupingUsed="false" maxFractionDigits="2"
																				minFractionDigits="2"
																				value="${cart.itemPrice / 1000 }" /></strong></td>
																	<td class="p-promotion"></td>
												...
												<div class="list">
													<span><em id="span-skuNum">1</em> 件商品，总商品金额：</span><em
														...
														v="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/1000 }"/>">￥<fmt:formatNumber
															groupingUsed="false" maxFractionDigits="2"
															minFractionDigits="2" value="${totalPrice/1000 }" /></em>
												</div>
												<div class="list">
...
.checkout-buttons .checkout-submit-disabled b {
	...
	cursor: not-allowed;
								...
								<span class="total">应付总额：<strong id="payPriceId">￥<fmt:formatNumber
											groupingUsed="false" maxFractionDigits="2"
											minFractionDigits="2" value="${totalPrice/1000 }" /></strong>元
								</span>
